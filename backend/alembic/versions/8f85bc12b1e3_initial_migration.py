...
Revision ID: 8f85bc12b1e3
Revises: 
Create Date: 2025-10-09 19:53:32.364637
...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('DRAFT', 'SUBMITTED', 'UNDER_REVIEW', 'DOCUMENT_VERIFICATION_PENDING', 'APPROVED', 'SOCIAL_WELFARE_APPROVED', 'REJECTED', 'FUND_DISBURSED', 'COMPLETED', name='applicationstatus'), nullable=True),
